...
import 'package:task1/core/localization/app_localization.dart';
...
class AppString {
  ...
  static String termsTitle =
      'The following General Terms & Conditions apply to your use of PEV and all related properties.';
  static String termsDescription1 =
  ...
  static String termsDescription2 =
      'The following General Terms & Conditions apply to your use of VC4A and all related properties. You are solely responsible for your conduct, and your content on VC4A, and compliance with these terms. By registering with us, or using or browsing VC4A, you acknowledge that you have read, understood, and agree to be bound by these terms. This includes the General Terms & Conditions explained on this page, and the VC4A Terms of Commerce, Disclaimer and Privacy Policy.';
...
class AppStringStyles {
  static TextStyle welcomeStyle = GoogleFonts.poppins().copyWith(
      color: AppColor.basicColor, fontSize: 25.0, fontWeight: FontWeight.w700);
  static TextStyle climatifyCommunityStyle = GoogleFonts.poppins().copyWith(
    color: AppColor.basicColor,
    fontSize: 28.0,
    fontWeight: FontWeight.w700,
  );
  static TextStyle loginButtonStyle = GoogleFonts.poppins().copyWith(
      color: AppColor.white, fontSize: 18.0, fontWeight: FontWeight.w700);
  static TextStyle signupButtonStyle = GoogleFonts.poppins().copyWith(
      color: AppColor.white, fontSize: 18.0, fontWeight: FontWeight.w700);
  static TextStyle selectedTabStyle = GoogleFonts.poppins().copyWith(
      color: AppColor.basicColor, fontSize: 20.0, fontWeight: FontWeight.w700);
  static TextStyle signupEntryButtonStyle = GoogleFonts.openSans().copyWith(
      color: AppColor.white, fontSize: 18.0, fontWeight: FontWeight.w700);
  static TextStyle haveAnAccountAlreadyStyle = GoogleFonts.openSans().copyWith(
      color: AppColor.shadedGrey, fontSize: 14.0, fontWeight: FontWeight.w400);
  static TextStyle unselectedTabStyle = GoogleFonts.poppins().copyWith(
      color: AppColor.shadedGrey, fontSize: 20.0, fontWeight: FontWeight.w700);
  static TextStyle signInButtonStyle = GoogleFonts.openSans().copyWith(
    color: AppColor.basicColor,
    fontSize: 14.0,
    fontWeight: FontWeight.w500,
    decoration: TextDecoration.underline,
    decorationColor: AppColor.basicColor,
  );
  static TextStyle doYouForgetPasswordButtonStyle = GoogleFonts.poppins()
      .copyWith(
          color: AppColor.basicColor,
          fontSize: 14.0,
          fontWeight: FontWeight.w500,
          decoration: TextDecoration.underline,
          decorationColor: AppColor.basicColor);
  static TextStyle orSignInWithStyle = GoogleFonts.inter().copyWith(
