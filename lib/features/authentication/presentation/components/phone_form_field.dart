        ...
        return TextFormField(
          ...
          decoration: InputDecoration(
            ...
            hintStyle: GoogleFonts.roboto().copyWith(
                color: labelColor ?? AppColor.shadedGrey,
              ...
              onTap: () {
                showCountryPicker(
                  ...
                  onSelect: (Country country) {
                    log('Select country: ${country.displayName} , ${country.countryCode} , ${country.phoneCode} , ${country.e164Key} , ${country.e164Sc} , ${country.example}');
