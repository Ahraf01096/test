...
import 'package:task1/core/shared/data/datasource/shared_local_datasource.dart';
import 'package:task1/core/shared/data/repository/shared_repository.dart';
...
import 'package:task1/features/authentication/domain/usecases/google_auth.dart';
import 'package:task1/features/authentication/domain/usecases/login_usecase.dart';
import 'package:task1/features/authentication/domain/usecases/register_usecase.dart';
import 'package:task1/features/authentication/domain/usecases/verify_code_usecase.dart';
import 'package:task1/features/authentication/presentation/controller/authentication/authentication_bloc.dart';
import 'package:task1/features/boarding/data/datasource/boarding_local_datasource.dart';
import 'package:task1/features/boarding/data/datasource/boarding_remote_data_source.dart';
import 'package:task1/features/boarding/presentation/controller/base_bloc/base_bloc.dart';
import 'package:task1/features/home/data/datasource/home_local_datasource.dart';
import 'package:task1/features/home/data/datasource/home_remote_data_source.dart';
import 'package:task1/features/home/data/repository/home_repository.dart';
import 'package:task1/features/home/domain/repository/base_home_repository.dart';
import 'package:task1/features/home/domain/usecases/get_posts_usecase.dart';
import 'package:task1/features/home/presentation/controller/home_bloc/home_bloc.dart';
import 'package:task1/features/notifications/presentation/controller/notifications_bloc/notifications_bloc.dart';
import 'package:task1/features/profile/presentation/controller/profile_bloc/profile_bloc.dart';
import 'package:task1/features/search/presentation/controller/search_bloc/search_bloc.dart';
import 'package:task1/features/settings/presentation/controller/settings_bloc/settings_bloc.dart';
...
import 'package:task1/features/stories/data/repository/stories_repository.dart';
